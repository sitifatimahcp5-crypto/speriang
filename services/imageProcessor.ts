// FIX: Import getAiClient function instead of the unexported 'ai' variable.
import { getAiClient } from './gemini/aiService';
...
export const preprocessImageTo916 = async (imageDataUrl: string): Promise<string> => {
  // FIX: Get the AI client using the exported helper function.
